...
self.addEventListener('fetch', e => {
  ...
  if (url.includes('unpkg.com') || url.includes('cartocdn') || url.includes('nominatim') || url.includes('openstreetmap') || url.includes('overpass-api.de') || url.includes('overpass.kumi.systems')) {
    return;
  }
